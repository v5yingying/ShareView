...
@property (nonatomic,strong) YYFocusModel *focusModel;
...
- (void) loadData{
    ...
    if ([api loadCacheWithError:nil]) {
        ...
        YYFocusModel *focusModel = [YYFocusModel yy_modelWithJSON:json];
    ...
    [api startWithCompletionBlockWithSuccess:^(__kindof YTKBaseRequest * _Nonnull request) {
        ...
        YYFocusModel *model = [YYFocusModel yy_modelWithJSON:request.responseObject];
